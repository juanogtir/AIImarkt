...
from main.models import Jugador, Equipo, Pais, PieChoice, PosicionPrincipal, PosicionSecundaria, Profesion,Usuario,Puntuacion
...
def populatePuntuaciones():
    ...
    for idUsuario in range(usuarios): #Para cada usuario
        ...
        for votacion in range(num_votaciones):
